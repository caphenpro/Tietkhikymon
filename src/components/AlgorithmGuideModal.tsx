      ...
      <div className="bg-slate-900 border border-slate-700 rounded-2xl max-w-3xl w-full max-h-[85vh] flex flex-col shadow-2xl overflow-hidden">
        ...
        <div className="p-6 overflow-y-auto space-y-6 text-xs sm:text-sm text-slate-300 leading-relaxed">
          ...
          <div className="bg-slate-950/60 p-4 rounded-xl border border-slate-800 space-y-2">
            ...
            <p>
              Kinh độ Mặt Trời hoàng đạo (λ<sub>Sun</sub>) trải dài 0° → 360°. Cứ mỗi 15° Mặt Trời đi qua tạo thành một Tiết Khí.
            </p>
            <ul className="list-disc list-inside space-y-1 pl-1 text-slate-400">
              <li>
                <strong className="text-slate-200">Tiết (Tiết Lệnh):</strong> Gồm 12 tiết: Lập Xuân (315°), Kinh Trập (345°), Thanh Minh (15°), Lập Hạ (45°), Mang Chủng (75°), Tiểu Thử (105°), Lập Thu (135°), Bạch Lộ (165°), Hàn Lộ (195°), Lập Đông (225°), Đại Tuyết (255°), Tiểu Hàn (285°). Tiết là thời điểm khởi đầu tháng mới trong Bát Tự Tứ Trụ.
              </li>
              <li>
