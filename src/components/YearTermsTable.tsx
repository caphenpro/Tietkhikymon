...
import { Calendar, Search, Download, Copy, Check, Filter, ChevronLeft, ChevronRight, ArrowLeft, ArrowRight, Compass, Layers, BookOpen } from 'lucide-react';
      ...
      {onNavigateTab && (
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-4 flex flex-wrap items-center justify-between gap-3 text-xs">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              id="btn-table-goto-prognostication"
